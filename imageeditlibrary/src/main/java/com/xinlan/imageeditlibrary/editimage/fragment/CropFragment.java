...
public class CropFragment extends BaseEditFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SELECTED_COLOR = getActivity().getResources().getColor(R.color.toolBarSelectedTextColor);
		UNSELECTED_COLOR = getActivity().getResources().getColor(R.color.toolBarTextColor);
	}
	...
	private final class CropImageTask extends AsyncTask<Bitmap, Void, Bitmap> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = AppBaseActivity.getLoadingDialog(getActivity(), R.string.saving_image,
					false);
			dialog.show();
		}
